      ...
      <div class="col-lg-4" :class="{ 'text-right': isRTL }">
        <card type="chart">
          <template slot="header">
            ...
            <h3 class="card-title">
              <i class="tim-icons icon-bell-55 text-primary"></i> 763,215,000 VND
            </h3>
          </template>
          <div class="chart-area">
            <line-chart
      ...
      <div class="col-lg-4" :class="{ 'text-right': isRTL }">
        <card type="chart">
          <template slot="header">
            ...
            <h3 class="card-title">
              <i class="tim-icons icon-delivery-fast text-info"></i> 3,500 đơn
            </h3>
          </template>
          <div class="chart-area">
            <bar-chart
      ...
      <div class="col-lg-4" :class="{ 'text-right': isRTL }">
        <card type="chart">
          <template slot="header">
            ...
            <h3 class="card-title">
              <i class="tim-icons icon-send text-success"></i> 125 đối tác
            </h3>
          </template>
          <div class="chart-area">
            <line-chart
